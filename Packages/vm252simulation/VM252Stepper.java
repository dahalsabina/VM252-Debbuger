...
public class VM252Stepper {
    ...
    public byte[] fetchMemoryBytes(int memoryAddress, int numberOfBytes) {
        ...
        for (int byteNumber = 0; numberOfBytes > 0; ++byteNumber, --numberOfBytes, memoryAddress = VM252ArchitectureSpecifications
                .nextMemoryAddress(memoryAddress))
    ...
    public String next_instruction(
        ...
        try {
            ...
            nextInstruction = new VM252ArchitectureSpecifications.Instruction(
    ...
    public void step() throws IOException {
        ...
        if (machineState().stoppedStatus() != VM252Model.StoppedCategory.stopped
                && machineState().stoppedStatus() != VM252Model.StoppedCategory.paused) {
            ...
            try {
                ...
                currentInstruction = new VM252ArchitectureSpecifications.Instruction(
